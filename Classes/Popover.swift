...
open class Popover: UIView {
    ...
    open func showAsDialog(_ contentView: UIView, inView: UIView) {
        ...
        self.show(contentView, point: point, inView: inView, overlayContainerView: inView)
    }
    ...
    open func show(_ contentView: UIView, fromView: UIView, inView: UIView, overlayContainerView: UIView? = nil) {
        let point: CGPoint
        switch self.popoverType {
        case .up:
        ...
        let overlayContainerView = { () -> UIView in
            if let overlayContainerView = overlayContainerView {
                return overlayContainerView
            }
            return inView
        }()
        
        self.show(contentView, point: point, inView: inView, overlayContainerView: overlayContainerView)
    }
    ...
    open func show(_ contentView: UIView, point: CGPoint) {
        ...
        self.show(contentView, point: point, inView: rootView, overlayContainerView: rootView)
    }
    ...
    open func show(_ contentView: UIView, point: CGPoint, inView: UIView, overlayContainerView: UIView) {
        if showBlackOverlay {
            ...
            overlayContainerView.addSubview(self.blackOverlay)
